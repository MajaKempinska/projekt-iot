...
Wizytówka zespołu – aplikacja webowa we frameworku **Flask (Python)**, skonteneryzowana **Dockerem** i wdrożona w chmurze **Microsoft Azure** (Azure Container Registry + App Service) w modelu PaaS.

Projekt zrealizowany w ramach przedmiotu *IoT & Cloud Computing* (Collegium Da Vinci).

**Autorzy:** Maja Kempińska, Joanna Skrzypczak
...
```
projekt-iot/
├── app.py              # Aplikacja Flask (trasy, formularz kontaktowy)
